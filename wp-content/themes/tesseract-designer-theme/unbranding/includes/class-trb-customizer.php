...
class Tesseract_Remove_Branding_Customizer {
	...
	public function live_preview() {
		...
		wp_enqueue_script( 'tesseract-remove-branding-customizer', get_template_directory_uri(). '/unbranding/assets/js/tesseract-remove-branding-customizer.js', array( 'jquery', 'customize-preview' ), Tesseract_Remove_Branding::VERSION, true );

	}

	public function enqueue_controls_javascript() {
		wp_enqueue_script( 'tesseract-remove-branding-controls', get_template_directory_uri(). '/unbranding/assets/js/tesseract-remove-branding-controls.js', array( 'jquery', 'customize-controls' ), Tesseract_Remove_Branding::VERSION, true );
	}

	public function frontend_style() {

		wp_enqueue_style( 'tesseract-remove-branding-frontend', get_template_directory_uri(). '/unbranding/assets/css/tesseract-remove-branding-frontend.css', array('tesseract-footer-banner'), Tesseract_Remove_Branding::VERSION );
