   	...
   	$args = array(  
			...
			$wp_customize->add_control(
				...
				new WP_Customize_Control(
					...
					array(
						...
						'label'         => __( 'Choose a layout type for product listings ( main shop and product category/tag archive pages, not applicable in Collection page. )', 'tesseract' ),
		...
		$wp_customize->add_setting( 'tesseract_woocommerce_product_button_option', array(
			...
			$wp_customize->add_control(
				...
				array(
					...
					'description' =>  __('<b><span style="font-size:17px; font-family:caption;" >Add to cart/Select Options/More Products(Loader) Button Settings.</span></b>', 'tesseract' ),
		...
		$wp_customize->add_control(
			...
			array(
				...
				'label'      => __( 'Button Color', 'tesseract' ),
		...
		$wp_customize->add_control(
			...
			new WP_Customize_Control(
				...
				array(
					...
					'label'          => __( 'Button radius for Rounded Corner', 'tesseract' ),
		...
		$wp_customize->add_control(
			...
			new WP_Customize_Control(
				...
				array(
					...
					'label'          => __( 'Button size', 'tesseract' ),
		...
		$wp_customize->add_setting( 'tesseract_woocommerce_button_backgroud', array(
		...
		$wp_customize->add_control(
			...
			'tesseract_woocommerce_button_backgroud_control',

			array(

				'label'      => __( 'Woo Buttons Background Color', 'tesseract' ),

				'section'    => 'tesseract_woocommerce',

				'settings'   => 'tesseract_woocommerce_button_backgroud',
		...
		$wp_customize->add_setting( 'tesseract_woocommerce_button_hover_color', array(
		...
		$wp_customize->add_control(
			...
			'tesseract_woocommerce_button_hover_color_control',

			array(

				'label'      => __( 'Woo Buttons Hover Color', 'tesseract' ),

				'section'    => 'tesseract_woocommerce',

				'settings'   => 'tesseract_woocommerce_button_hover_color',
		...
		$wp_customize->add_control(
			...
			array(
				...
				'label'      => __( 'Woo Buttons Text Color', 'tesseract' ),
