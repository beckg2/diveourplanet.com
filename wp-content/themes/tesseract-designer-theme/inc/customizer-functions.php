...
function tesseract_sanitize_radio_nextToMenu_left( $value ) {
	...
	if ( ! in_array( $value, array( 'nothing', 'logo', 'social', 'contact', 'search', 'menu', 'html' ) ) ) :
...
function tesseract_sanitize_radio_mob_shadow_color( $value ) {
	...
	if ( ! in_array( $value, array( 'none','dark', 'light', 'custom' ) ) ) :
...
function tesseract_sanitize_select_header_layout_types( $value ) {
	...
	if ( ! in_array( $value, array( 'none', 'navbottom', 'navright', 'navleft' ,'logoleftnavleft', 'navcentered', 'vertical-left', 'vertical-right', 'centered-inline-logo', 'defaultlayout' ) ) ) :
...
function tesseract_button_textarea_enable2() {



	$textarea_enable = get_theme_mod( 'tesseract_header_right_content' );

	$right_area_enable = get_theme_mod( 'tesseract_header_layout_setting' );

	$bool = ( $textarea_enable == 'buttons' &&  $right_area_enable == 'defaultlayout' ) ? true : false;
...
function tesseract_header_right_area_enable() {



	$right_area_enable = get_theme_mod( 'tesseract_header_layout_setting' );

	$bool = ( $right_area_enable == 'defaultlayout' ) ? true : false;
...
function tesseract_vertical_header_width_enable() {
	...
	$bool1 = ( ( $vertwidth_enable == 'vertical-left' ) || ( $vertwidth_enable == 'vertical-right' ) || ( $vertwidth_enable == 'navright' ) ) ? true : false;
...
function tesseract_vertical_header_width_enable_2() {
...
function tesseract_header_logo_choice_image()
{
...
function tesseract_header_upper_layout_choice_1()
{
	$layout_enable = get_theme_mod( 'tesseract_header_layout_setting' );

	$bool3_1 = ( ( $layout_enable == 'logoleftnavleft' ) || ( $layout_enable == 'navbottom' ) || ( $layout_enable == 'navright' ) || ( $layout_enable == 'navcentered' ) || ( $layout_enable == 'centered-inline-logo' ) || ( $layout_enable == 'navleft' ) || ( $layout_enable == 'defaultlayout' ) ) ? true : false;
	return $bool3_1;
}


function tesseract_header_upper_layout_choice()
{
	$layout_enable = get_theme_mod( 'tesseract_header_layout_setting' );
	$top_enable = (get_theme_mod( 'tesseract_header_upper_status' )) ? get_theme_mod( 'tesseract_header_upper_status' ) : 'enable';

	$bool3 = ( ( $layout_enable == 'navbottom' ) || ( $layout_enable == 'navright' ) || ( $layout_enable == 'navcentered' ) || ( $layout_enable == 'centered-inline-logo' ) || ( $layout_enable == 'navleft' ) || ( $layout_enable == 'defaultlayout' ) || ( $layout_enable == 'logoleftnavleft' )) ? true : false;
	if($top_enable != 'enable'){
		$bool3 = false;
	}
...
function tesseract_header_upper_left_content_type_choice()
{
	$header_upper_left_content_type = get_theme_mod( 'tesseract_header_upper_left_content_type' );
	$top_enable = (get_theme_mod( 'tesseract_header_upper_status' )) ? get_theme_mod( 'tesseract_header_upper_status' ) : 'enable';

	$bool4 = ( ( $header_upper_left_content_type == 'text' ) || ( $header_upper_left_content_type == 'textsocial' ) ) ? true : false;
	if($top_enable != 'enable'){
		$bool4 = false;
	}
	return $bool4;
...
function tesseract_header_upper_centre_content_type_choice()
{
	$header_upper_centre_content_type = get_theme_mod( 'tesseract_header_upper_centre_content_type' );
	$top_enable = (get_theme_mod( 'tesseract_header_upper_status' )) ? get_theme_mod( 'tesseract_header_upper_status' ) : 'enable';

	$bool5 = ( $header_upper_centre_content_type == 'carttext' )  ? true : false;
	if($top_enable != 'enable'){
		$bool5 = false;
	}
	return $bool5;
...
function tesseract_header_upper_right_content_type_choice()
{
	$header_upper_right_content_type = get_theme_mod( 'tesseract_header_upper_right_content_type' );
	$top_enable = (get_theme_mod( 'tesseract_header_upper_status' )) ? get_theme_mod( 'tesseract_header_upper_status' ) : 'enable';

	$bool6 = ( ( $header_upper_right_content_type == 'text' ) || ( $header_upper_right_content_type == 'textsocial' ) ) ? true : false;
	if($top_enable != 'enable'){
		$bool6 = false;
	}
	return $bool6;
...
function tesseract_footer_left_menu_select_enable()
{
	$left_ch = get_theme_mod( 'tesseract_footer_additional_content' );
	$left_ch1 = ( ( $left_ch == 'menu' ) ) ? true : false;
	return $left_ch1;
}

function tesseract_footer_additional_content_html_active()
{
	$left_html = get_theme_mod( 'tesseract_footer_additional_content' );
	$html_1 = ( ( $left_html == 'html' ) ) ? true : false;
	return $html_1;
}