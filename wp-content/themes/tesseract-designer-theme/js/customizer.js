...
( function( $ ) {
	...
	wp.customize( 'footer_menu_text_fonts', function( value ) {
		value.bind( function( newval ) {
			...
			$('#footer-banner-centre').css( 'font-family', newval );
			$('#footer-banner-right').css( 'font-family', newval );
	...
	wp.customize('tesseract_header_colors_bck_color_opacity', function(value){
		value.bind(function( to ){
			...
			$('.site-header, .site-header .cart-content-details, .main-navigation ul ul a, #header-right-menu ul ul a').css( 'background-color', result+' !important');
