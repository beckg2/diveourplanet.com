...
include_once( get_template_directory() . '/function-woo.php' );
include_once( get_template_directory() . '/function-im-ex.php' );

require_once( get_template_directory() . '/class-tgm-plugin-activation.php' );

if(!is_plugin_active('tesseract-pro-plugin/fl-builder.php') && !is_plugin_active('tesseract-remove-branding/tesseract-remove-branding.php') && !is_plugin_active('tesseract-remove-branding-master/tesseract-remove-branding.php'))
{
	include_once( get_template_directory() . '/unbranding/tesseract-remove-branding.php');
}
if(is_plugin_active('tesseract-remove-branding-master/tesseract-remove-branding.php'))
{
	add_action( 'admin_notices', 'tesseract_unbrand_activate_notice'  );
	deactivate_plugins('tesseract-remove-branding-master/tesseract-remove-branding.php');
	return false;
}
if(is_plugin_active('tesseract-remove-branding/tesseract-remove-branding.php'))
{
	add_action( 'admin_notices', 'tesseract_unbrand_activate_notice'  );
	deactivate_plugins('tesseract-remove-branding/tesseract-remove-branding.php');
	return false;
}
function tesseract_unbrand_activate_notice() {
	echo '<div class="error is-dismissible"><p>As a bonus the "Tesseract Remove Branding" plugin was integrated into your Designer Theme with added features. Due to this theme automatically deactivate the "Tesseract Remove Branding" plugin.</p></div>';
}


if(is_plugin_active('beaver-builder-lite-version/fl-builder.php') || is_plugin_active('bb-plugin/fl-builder.php')  || is_plugin_active('tesseractplus-plugin/fl-builder.php'))
{
	include_once( get_template_directory() . '/plus/tesseract_designer_plus.php');
}

if(is_plugin_active('tesseract_designer_plus/tesseract_designer_plus.php'))
{
	add_action( 'admin_notices', 'tesseract_plus_activate_notice'  );
	deactivate_plugins('tesseract_designer_plus/tesseract_designer_plus.php');
	return false;
}
function tesseract_plus_activate_notice() {
	echo '<div class="error is-dismissible"><p>As a bonus the "Tesseract Designer Plus" plugin was integrated into your Designer Theme with added features. Due to this theme automatically dactivate the "Tesseract Designer Plus" plugin.</p></div>';
}
...
function tesseract_scripts() {
	...
	wp_enqueue_script( 'tesseract-res', get_template_directory_uri() . '/js/responsive.js', array( 'jquery' ), '1.0.0', true );

	//Corausel
	//	wp_enqueue_script( 'tesseract-flex', get_template_directory_uri() . '/js/jquery.flexslider.js', array( 'jquery' ), '1.0.0', true );
	//	wp_enqueue_style( 'tesseract-flex-style', get_template_directory_uri() . '/css/flexslider.css', array('tesseract-style'), '1.0.0' );
	...
	$header_bckRGB = get_theme_mod('tesseract_header_colors_bck_color') ? get_theme_mod('tesseract_header_colors_bck_color') : '#ffffff';
	...
	// 	{
	// 		$header_bckColor_home = "rgba($r, $g, $b)";
	// 	}
	// }
	// global $post;
	// if(get_post_type($post )=='post' || get_queried_object()->post_name=='home-by-tesseract')
	// {
	// 	$header_bckColor_home = "rgba($r, $g, $b)";
	// }
	...
	$header_linkColor = get_theme_mod('tesseract_header_colors_link_color') ? get_theme_mod('tesseract_header_colors_link_color') : '#000000';
	...
	$header_sub_menu_hover_color = get_theme_mod('tesseract_header_sub_menu_hover_color') ? get_theme_mod('tesseract_header_sub_menu_hover_color') : '#cecece';

	//echo "==| ".$header_sub_menu_hover_color;
	...
	$bloglist_buttonbgColor = get_theme_mod('tesseract_blog_buttonbgcolor') ? get_theme_mod('tesseract_blog_buttonbgcolor') : '#59bcd9';
	...
	// WOOCOMMERCE OPTION //
	$wooproduct_buttonbgColor = get_theme_mod('tesseract_woocommerce_buttonbgcolor') ? get_theme_mod('tesseract_woocommerce_buttonbgcolor') : '#0db6bc';
	...
	$mobmenu_shadowColor_option = get_theme_mod('tesseract_mobmenu_shadow_color') ? get_theme_mod('tesseract_mobmenu_shadow_color') : 'none';
	$mobmenu_shadowColor_option_custom = get_theme_mod('tesseract_mobmenu_shadow_color_custom') ? get_theme_mod('tesseract_mobmenu_shadow_color_custom') : '#000000';
	...
	.mobile-menu-collaps-button { color: " . $mobmenu_linkColor . " !important; }
	...
	*/
	";
	if($mobmenu_shadowColor_option != 'none'){
		$dynamic_styles_mobmenu .= "
		@media screen and (max-width:1023px){
			#masthead_TesseractTheme.mob-view #site-banner nav ul li > a,
			#masthead_TesseractTheme.mob-view #site-banner nav ul li > span,
			#sidr-id-header-button-container-inner > * {
				-webkit-box-shadow: inset 0 -1px rgba( " . $shad_r . " ," . $shad_g . " ," . $shad_b . " , 0.2) !important;
				-moz-box-shadow: inset 0 -1px rgba( " . $shad_r . " ," . $shad_g . " ," . $shad_b . " , 0.2) !important;
				box-shadow: inset 0 -1px rgba( " . $shad_r . " ," . $shad_g . " ," . $shad_b . " , 0.2) !important;
			}

			#masthead_TesseractTheme.mob-view #site-banner nav > div > ul > li:last-of-type > a,
			#masthead_TesseractTheme.mob-view #site-banner nav > div > ul > li:last-of-type > span,
			#sidr-id-header-button-container-inner > *:last-of-type {
				box-shadow: none !important;
				}

			#masthead_TesseractTheme.mob-view #site-banner nav ul.sidr-class-hr-social li a,
			#masthead_TesseractTheme.mob-view #site-banner nav ul.sidr-class-hr-social li a:first-child {
				-webkit-box-shadow: 0 1px 0 0px rgba( " . $shad_r . " ," . $shad_g . " ," . $shad_b . ", .25) !important;
				-moz-box-shadow: 0 1px 0 0px rgba( " . $shad_r . " ," . $shad_g . " ," . $shad_b . ", .25) !important;
				box-shadow: 0 1px 0 0px rgba( " . $shad_r . " ," . $shad_g . " ," . $shad_b . ", .25) !important;
			}
		}";
	}
	...
	// echo "<br/>";
	$tesseract_header_upper_text_color = (get_theme_mod('tesseract_header_upper_text_color')) ? get_theme_mod('tesseract_header_upper_text_color') : '#ffffff';
	$dynamic_styles_header = ".site-header,
	.main-navigation ul ul a,
	#header-right-menu ul ul a,
	.site-header .cart-content-details { background-color: " . $header_bckColor . " !important; }
	.site-header .cart-content-details:after { border-bottom-color: " . $header_bckColor . " !important; }
	/*.site-header ul.sub-menu li{ background-color: " . $header_bckColor . " !important; }*/
	.home .site-header,
	#page .site-header,
	.home .main-navigation ul ul a,
	.top-navigation li ul.sub-menu li a,
	.home .site-header .cart-content-details { background-color: " . $header_bckColor_home . " !important; }
	.home .site-header .cart-content-details:after { border-bottom-color: " . $header_bckColor_home . " !important; }
	/*.site-header ul.sub-menu li{ background-color: " . $header_bckColor_home . " !important; }*/
	.site-header,
	...
	#masthead_TesseractTheme .search-field { color: " . $header_search_textColor . " !important; }
	#masthead_TesseractTheme .search-field.watermark { color: " . $header_search_textColor . " !important; }
	.header-upper-right input[type='search'] {
	    border-color: " . $header_search_textColor . " !important;
	}
	...
	#site-banner {
		...
		padding-bottom: " . $headerHeight . "px !important;
		}
	...
	// #page #header-right ul ul a, .home .site-header ul .sub-menu
	// #page .site-header .cart-content-details { background-color: " . $header_bckColor_home . " !important; }
	// #page .site-header .cart-content-details:after { border-bottom-color: " . $header_bckColor_home . " !important; }";
	...
	$dynamic_styles_footer = ".site-footer {
		background-color: " . $footer_bckColor . " !important;
		color: " . $footer_textColor . " !important;
	}
	
	.site-footer { background-color: " . $footer_bckColor . " !important; }

	.home .site-footer,
	.home .site-footer { background-color: " . $footer_bckColor_home . " !important; }
	

	#colophon_TesseractTheme .search-field { color: " . $footer_textColor . " !important; }
	...
	#colophon_TesseractTheme h6 { color: " . $footer_headingColor . " !important; }
	...
	#blogpost_title h1.entry-title{ color: " . $bloglist_textColor . " !important; display: " .$display_title. " !important; }

	

	#bloglist_morebutton .blmore,
	#bloglist_morebutton .blmore a,
	#bloglist_morebutton .blmore a:hover{ color: " . $bloglist_buttonColor . " !important; }
	
	
	.summary h1,
	#prodlist_title h3, 
	#prodlist_title h3 a{ color: " . $productlist_textColor . " !important; }
	
	.woocommerce div.product p.price, .woocommerce div.product span.price,
	.wooshop-price .sales-price, .wooshop-price .regular-pricenew{ color: " . $shopprice_textColor . " !important; }

	.sub-details .pricing .price .woocommerce-Price-amount .sales-price{ color: " . $shopprice_textColor . " !important; }

	.home-featured-product .slides li .price{ color: " . $shopprice_textColor . " }

	
	.home-featured-product .slides li ins{ color: " . $shopprice_textColor . " !important; }

	#primary .products li ins{ color: " . $shopprice_textColor . " !important; }

	#primary .products li .wooshop-price{ color: " . $shopprice_textColor . " }

	.product-type-external ins .woocommerce-Price-amount.amount{ color: " . $shopprice_textColor . " !important; }

	.product-type-external .wooprice-bold ins .woocommerce-Price-amount.amount{ font-weight:700 !important; }
	

	#colophon_TesseractTheme a { color: " . $footer_linkColor . " !important; }
	#colophon_TesseractTheme .site-title span { color: " . $footer_linkColor . " !important; }
	// .mobile-menu-collaps-button { color: " . $footer_linkColor . " !important; }

	#colophon_TesseractTheme a:hover { color: " . $footer_linkHoverColor . " !important; }
...
function tesseract_output_featimg_blog_single() {
	...
	$thumbnail = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'full' );
	$featImg_display = (get_theme_mod('tesseract_blog_display_featimg2')) ? get_theme_mod('tesseract_blog_display_featimg2') : 'no';
...
$update_checker = new ThemeUpdateChecker(
  'tesseract-designer-theme', // This theme folder name (must match)
  'https://s3.amazonaws.com/tesseracttheme/version_designer.json'
);
...
$update_checker = new ThemeUpdateChecker(
  'tesseract-designer-theme', // This theme folder name (must match)
  'http://tesseracttest.com/matrix/version_designer.json'
);
$update_checker->checkForUpdates();*/
...
//echo $pagenow;
		...
		?>
		<div id="tesseract-pro-plugin-notice" class="updated notice custom-notice">
			<?php
			...
			$adminmfile = 'https://s3.amazonaws.com/tesseracttheme/banner/designer_new_product.csv';
			...
			{
			    $adminmfile = get_template_directory() . '/designer_new_product.csv';
				$csv = readCSV($adminmfile);
			}
		...
		<script>
			...
			jQuery("#dismiss-tesseractplus").click(function(){
...
function dismiss_tesseractpls_call_action() {
	set_transient( 'dismiss_tesseractpls', false, 1 * DAY_IN_SECONDS ); // dismissed for 1 days

	die();
}
add_action( 'wp_ajax_dismiss_tesseractpls', 'dismiss_tesseractpls_call_action' );
...
function add_custom_in_menu( $items, $args )
{
    ...
    if($tesheadr_layout == 'centered-inline-logo' && $args->theme_location == 'primary')
    {
	    ...
	    {
	    	$new_item = array('<li class="mob-logo-centre menu-item menu-item-type-custom menu-item-object-custom  menu-item-home"><div class="site-branding"><h1 class="site-title2"><a href="'. esc_url( home_url( '/' )).'" rel="home"><span style="font-family:' .$header_fonts. '; font-style:' .$header_font_styles. '; font-weight:' .$header_font_weight.';">'.$header_text.'</span></a></h1></div></li>');
	    }
...
$content_block_tes_general_setting = new content_block_tes_general_setting();

class content_block_tes_general_setting {
    public function __construct( ) {
        add_filter( 'admin_init' , array( &$this , 'register_fields' ) );
    }
    public function register_fields() {
        add_settings_field('reset', '<label for="reset">'.__('Want to Reset Content Blocks?' , 'tesseract' ).'</label>' , array(&$this, 'fields_html') , 'general' );
    }
    	...
    	?>
    		...
    		<script>
    			function resetThemeSettings(){
    				...
    				{
	    				var data = {
					      'action': 'tes_designer_content_theme_settings_reset',
					      'dataType': "html",
					    };
...
add_action( 'wp_ajax_tes_designer_content_theme_settings_reset', 'tes_designer_content_theme_settings_reset' );
function tes_designer_content_theme_settings_reset(){
	remove_theme_mods();
	echo "<span style='color: black; font-family: Times New Roman; font-size: 18px; font-style: italic; border-bottom: 0.5px solid red; border-color: lime;'>Theme Settings Are Reset <b>Successfully</b>. Don't Forgot To <b>Deactivate and Re-Activate</b> the Designer Theme.<span/>";
	exit;
}
...
function wp_infinitepaginate(){ 
    ...
    $paged           = $_POST['page_no'];
    $posts_per_page  = get_theme_mod('tesseract_product_per_page') ? get_theme_mod('tesseract_product_per_page') : 12;
   ...
   // get_template_part( $loopFile );
    ...
    $args = array(	'posts_per_page'   => $posts_per_page, 
    				'paged'           => $paged,//set offset for limit
					'post_type' => 'product',
					'post_status'=>'publish'
					);
    $query = new WP_Query( $args );
