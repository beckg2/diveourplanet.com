...
$wc_headercart = ( get_theme_mod('tesseract_woocommerce_headercart') == 'yes' ) ? true : false;


$right_area_enable = ( get_theme_mod( 'tesseract_header_layout_setting' ) ) ? get_theme_mod( 'tesseract_header_layout_setting' ) : 'defaultlayout';
if($headright_content != 'no-right-content' &&  $right_area_enable == 'defaultlayout'){
