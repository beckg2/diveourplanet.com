...
<li <?php post_class(); ?>>
	<div class="product card">
		 ...
		 */
		 ...
		 ?>
		<?php	$prodregprice = get_post_meta( $product->get_id(), '_regular_price', true);
				$prodsalesprice = get_post_meta( $product->get_id(), '_price', true);	
		?>
		 <div style="font-size: <?php echo $wooprice; ?>px;" class="wooshop-price <?php echo $wooprice_classbold; ?> price-tesseract">
			<?php /*if( ($prodregprice != '') && ($prodsalesprice != '') ) { ?>		
					<span class="regular-price">
						<?php echo get_woocommerce_currency_symbol(); ?>
						<?php echo $prodregprice; ?>
					</span>
			<?php } elseif( ($prodregprice != '') && ($prodsalesprice == '') ) { ?>		
					<span class="regular-pricenew">
						<?php echo get_woocommerce_currency_symbol(); ?>
						<?php echo $prodregprice; ?>
					</span>
			<?php } ?>
			<?php if($prodsalesprice != '') { ?>
				<span class="sales-price">
					<?php echo get_woocommerce_currency_symbol(); ?>
					<?php echo $prodsalesprice; ?>
				</span>
			<?php } */?>
			<?php
			...
			<?php $wooaddbutton = (get_theme_mod('tesseract_woocommerce_product_morebutton')) ? get_theme_mod('tesseract_woocommerce_product_morebutton') : 'showcartbutton';  ?>
					<?php if($wooaddbutton == 'showcartbutton' ) {?>
						...
						echo apply_filters( 'woocommerce_loop_add_to_cart_link',
							sprintf( '<a style="background-color: '.$woobutton_bgcolor.'; border-radius: '.$woobutton_brderradius.'px; color: '.$woobutton_text_color.';" href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="button '.$woobutclass.' %s product_type_%s">%s</a>',
