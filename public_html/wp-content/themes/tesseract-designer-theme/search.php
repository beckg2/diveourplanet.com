...
get_header(); ?>
	...
	<?php
		...
		switch ( $slayout ) {
			...
			case 'sidebar-right':
				...
				$primary_class = 'content-area sidebar-right sidebar-right-alt';
				$secondary_class = 'default-right';
	...
	<?php
		...
		if ( !$slayout || ( $slayout == 'sidebar-left' ) || ( $slayout == 'sidebar-right' ) ) {
			?>
				<div id="secondary" class=" <?php echo $secondary_class; ?> widget-area sidebar-default woo-left-sdebar">
