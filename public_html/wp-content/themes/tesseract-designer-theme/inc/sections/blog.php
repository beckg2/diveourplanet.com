 ...
 */					 			
   	...
   	$wp_customize->add_section( 'tesseract_blog' , array(
		...
		$wp_customize->add_setting( 'tesseract_blog_content', array(
			...
			/*$wp_customize->add_setting( 'tesseract_single_blog_post_layout', array(
			...
			$wp_customize->add_control(
				...
				new WP_Customize_Control(
					...
					'tesseract_single_blog_post_layout_control',

					array(

						'label'         => __( 'Choose a layout type for the Single Blog Post page', 'tesseract' ),

						'section'       => 'tesseract_blog',

						'settings'      => 'tesseract_single_blog_post_layout',
			...
			$wp_customize->add_control(
				...
				new WP_Customize_Control(
					...
					array(
						...
						'label'          => __( 'Feature Image Display', 'tesseract' ),
		...
		$wp_customize->add_setting( 'tesseract_blog_button_txt',
			array(
				'default' => 'Read More',
				'transport' => 'refresh'
			)
		...
		$wp_customize->add_control( 
			new WP_Customize_Control(
				...
				'tesseract_blog_button_txt_control',
				array(
					'label'          => __( 'Read More Text', 'tesseract' ),
					'section'        => 'tesseract_blog',
					'settings'       => 'tesseract_blog_button_txt',
					'type'           => 'text',
					'priority' 		 => 11						
