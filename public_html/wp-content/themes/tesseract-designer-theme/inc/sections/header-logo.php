 ...
 */	
   	...
   	$wp_customize->add_section( 'tesseract_header_logo' , array(
    	...
    	'description' 		=> '<b><span style="font-color:blue; font-size:20px; padding-left:32px; font-family:caption;" ><a href="http://logomakr.com" target="_blank">Create Your Logo</a></span><b><br/>Make Your Own Logo And Upload Here.',
		...
		$wp_customize->add_control(
			   ...
			   new WP_Customize_Image_Control(
				   ...
				   array(
					   ...
					   'active_callback' 	=> 'tesseract_header_logo_choice_image',
